...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','EMall','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas'),
        'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
        'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
        'DEFAULT_MODULE'        =>  'EMall',  // 默认模块
        ...
        'SESSION_TYPE'=>'',
        'SESSION_TABLE'=>'cmf_think_session',
        'SESSION_EXPIRE'=>'600',
        'SESSION_USER_TABLE' => 'cmf_users',
